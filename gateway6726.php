...
<head>
	...
	<style>
		.banner {
			background-image: url('www.payuspalot.online/img/gateway.jpg');
      ...
      <a href="#"></a> </p>
        ...
        <div class="row footer-credit">
          <div class="col-md-6 col-sm-6">
            <p>&copy; 2023, <a href="#">Ujjwal kesharwani</a> | All rights reserved.</p>
          </div>
          <div class="col-md-6 col-sm-6">
            <ul class="footer-menu">
              <li><a href="refund.php">Refund</a></li>
              <li><a href="privacy.php">Privacy Policy</a></li>
              <li><a href="t%26c.php">Terms &amp; Condition</a></li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer" style="text-align:center;">
					<a href="tel:+18888888888" class="btn btn-success">Call Now</a>
					<button type="button" class="btn btn-primary">Email us</button>
				</div>
			</div>
		</div>
	</div>
